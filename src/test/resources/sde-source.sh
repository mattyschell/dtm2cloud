...
rm src/test/resources/tax_block_point.*
rm src/test/resources/tax_lot_point.*
# lovely test data load and shp creation from postgis
pgsql2shp -f "src/test/resources/tax_block_point" -h localhost -u postgres dtmtest "tax_block_point"
pgsql2shp -f "src/test/resources/tax_lot_point" -h localhost -u postgres dtmtest "tax_lot_point"
