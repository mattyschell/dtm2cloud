...
-- this will error in specatuclarly confusing ways
-- if the environment is not configured as expected
create extension if not exists postgis;

-- as currently defined 
-- Source SDE TAX_BLOCK_POLYGON --> target DTM TAX_BLOCK
-- They must have differing names because they live in the same Oracle schema
-- Target TAX_BLOCK has a subset of columns from source TAX_BLOCK_POLYGON 
-- Consider breaking free and naming target TAX_BLOCK_POLYGON also 
